    ...
    <div class="container">
        <div class="header  d-flex flex-column justify-content-between align-items-center mt-5">
            <div class="d-flex justify-content-between w-100 mb-3">
                <div>
                    <h1 class="h2 d-block mb-0 tiny-title">Artistas</h1>
                </div>
                <div class="flex-column align-content-center justify-content-center">
                    <a class="btn  btn-primary" href="{{ route('admin.artistas.create') }}">+ Artista</a>
                </div>
            </div>
        </div>
                ...
                <table class="table table-responsive table-striped table-sm">
                    <thead>
                        <tr class="border-bottom-white">
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Movimentos</th>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center gap-1 align-middle">
                                        ...
                                        <div class="d-md-none d-table-cell">
                                            <a href="{{ route('admin.artistas.edit', $artista) }}" class="btn btn-primary m-0 btn-sm d-flex">
                                                <span class="material-symbols-outlined">edit</span>
                                            </a>
                                        </div>
                                        <form class="ms-2" action="{{ route('admin.artistas.destroy', $artista->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <div class="d-none d-md-table-cell">
                                            <a href="{{ route('admin.artistas.show', $artista->id) }}" class="btn btn-primary m-0 btn-sm btn_detalhes d-flex align-items-center gap-1" > <!-- data-index="" data-bs-toggle="modal" data-bs-target="#modalDetalhes" -->
                                                <span class="material-symbols-outlined">visibility</span>
                                                <span>Detalhes</span>
                                            </a>
                                        </div>
                                        <div class="d-md-none d-table-cell">
                                            <a href="{{ route('admin.artistas.show', $artista->id) }}" class="btn btn-primary m-0 btn_detalhes btn-sm d-flex align-items-center gap-1">
                                                <span class="material-symbols-outlined">visibility</span>
                                            </a>
                                        </div>
                                    </td>
